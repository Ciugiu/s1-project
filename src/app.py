...
import data_request, first_chart, second_chart
...
def login():
    if request.method == 'POST':
        ...
        with open('data_request_ids.py', 'w') as f:
            f.write(f"host = '{host}'\n")
            f.write(f"user = '{user}'\n")
...
def index():
    ...
    with open('sql_scripts/active_population.sql', 'r') as file:
        querry = file.read()
    ...
    with open('sql_scripts/overall_attendance.sql', 'r') as file:
        querry = file.read()
...
def populations(year, period, course):
    ...
    with open('sql_scripts/students_table.sql', 'r') as file:
        querry = file.read()
    ...
    with open('sql_scripts/courses_table.sql', 'r') as file:
        querry = file.read()
...
def grades(year, period, course):
    ...
    with open('sql_scripts/student_final_table.sql', 'r') as file:
        querry = file.read()
